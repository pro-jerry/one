...
<script type="text/javascript">
		...
		$('#form').form({
			...
			success : function(result){
				...
				if (result.success) {
					...
					//之所以能在这里调用到parent.$.modalDialog.openner_treeGrid这个对象，是因为role.jsp页面预定义好了
					//reloadData();
	...
	function reloadData(){
		$.post('${pageContext.request.contextPath}/roleController/treeGrid',function(data){
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					<th>编号</th>
					<td><input name="id" type="text" class="span2" value="${role.id}" 
						readonly="readonly"></td>
					<th>角色名称</th>
					<td><input name="name" type="text" class="easyui-validatebox span2" 
						placeholder="请输入角色名称" data-options="required:true" value=""></td>
				</tr>
				<tr>
					<th>排序</th>
