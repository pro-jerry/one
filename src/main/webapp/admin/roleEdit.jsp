		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>角色名称</th>
					<td><input name="name" type="text" placeholder="请输入角色名称" class="easyui-validatebox span2" 
						data-options="required:true" value="${role.name}"></td>
				</tr>
				<tr>
					<th>排序</th>
					<td><input name="seq" value="${role.seq}" class="easyui-numberspinner" style="width: 140px; height: 29px;" 
