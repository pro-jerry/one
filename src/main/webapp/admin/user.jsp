...
<html>
  <head>
    ...
    <c:if test="${fn:contains(sessionInfo.privilegeList,'/userController/editPage')}">
    	 <script type="text/javascript">
    		 $.canEdit = true;
    	 </script>
    </c:if>
    <c:if test="${fn:contains(sessionInfo.privilegeList, '/userController/delete')}">
		<script type="text/javascript">
			$.canDelete = true;
		</script>
	</c:if>
	<c:if test="${fn:contains(sessionInfo.privilegeList, '/userController/grantPage')}">
		<script type="text/javascript">
			$.canGrant = true;
		</script>
	</c:if>
	<c:if test="${fn:contains(sessionInfo.privilegeList, '/userController/editPwdPage')}">
		<script type="text/javascript">
			$.canEditPwd = true;
		</script>
	</c:if>
  ...
  <body>
  		...
  		<div data-options="region:'north',border:false" style="height:50px;overflow:hidden">
  			<form id="searchForm">
					...
					<tr>
						<th>创建时间</th>
						<td><input
						name="createdatetimeStart" 
						class="span2 easyui-datetimebox" 
						/>
						至<input 
						class="span2 easyui-datetimebox" 
						name="createdatetimeEnd" 
						 /></td>
					</tr>
					<tr>
						<th>最后修改时间</th>
  	...
  	<div id="toolbar" style="display: none;">
  		<c:if test="${fn:contains(sessionInfo.privilegeList, '/userController/addPage')}">
		...
		<c:if test="${fn:contains(sessionInfo.privilegeList, '/userController/batchDelete')}">
